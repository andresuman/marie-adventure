...
Jogo 2D de plataforma + quiz educativo em **Phaser 3** (HTML/JS puro), rodando direto no navegador — sem instalação, sem dependências de build.

Criado para celebrar os **100 anos da visita de Marie Curie a Águas de Lindóia** (1926–2026). Ajude a cientista a correr pelas ruas da cidade termal, desviar das capivaras, coletar blocos de quiz com curiosidades históricas e chegar até a garrafa de água antes que o tempo acabe — em **duas fases**: Thermas de Lindoya (1926) e Águas de Lindóia (2026).
...
| Selecionar resposta do quiz | ↑ / ↓ | toque na alternativa |
...
- Colete os **blocos de quiz** no ar para responder curiosidades sobre Marie Curie, Thermas de Lindoya e Águas de Lindóia.
...
- Cada resposta correta no quiz rende **+500 pontos**; respostas erradas não tiram vida nem pontos.
...
- O desempenho no quiz também é salvo no navegador e aparece no fim da partida como **Curiosidades: acertos/tentativas**.
...
- **SFX** (pulo, passagem limpa, coleta de quiz, resposta correta/errada, pisar em capivara, dano, vitória) ativos por padrão em todos os navegadores.
...
├── QuizStats.js            # Persistência de acertos/tentativas do quiz (localStorage)
├── data/
...
│   ├── GameScene.js        # Loop principal, capivaras, blocos de quiz e fases
...
├── assets/                 # Sprites, cenário e bloco de quiz (PNG)
